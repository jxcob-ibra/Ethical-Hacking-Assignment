<?php
/**
 * phpMyAdmin Access Control Configuration
 * This file checks the exposed_database vulnerability state
 * This file is mounted as config.secret.inc.php in phpMyAdmin container
 */
